...
Friend Class frmVATList
	...
	Private Sub loadLanguage()
		...
		'frmVATList = No Code   [Select a VAT Rate]
		'rsLang.filter = "LanguageLayoutLnk_LanguageID=" & 0000
		'If rsLang.RecordCount Then frmVATList.Caption = rsLang("LanguageLayoutLnk_Description"): frmVATList.RightToLeft = rsLang("LanguageLayoutLnk_RightTL")
		...
		rsLang.filter = "LanguageLayoutLnk_LanguageID=" & 1065 'New|Chekced
		...
		'UPGRADE_ISSUE: Form property frmVATList.ToolTip1 was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
    ...
    Private Sub DataList1_DblClick(ByVal eventSender As System.Object, ByVal eventArgs As KeyPressEventArgs) Handles DataList1.DoubleClick
        ...
        If DataList1.BoundText <> "" Then
            frmVAT.loadItem(CInt(DataList1.BoundText))
        End If
        doSearch()
    End Sub
	...
	Private Sub frmVATList_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
	...
	Private Sub frmVATList_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		gRS.Close()
	End Sub
	...
	Private Sub doSearch()
		...
		If lString = "" Then
		Else
			lString = "WHERE (VAT_Name LIKE '%" & Replace(lString, " ", "%' AND VAT_Name LIKE '%") & "%')"
		End If
		gRS = getRS("SELECT DISTINCT VATID, VAT_Name FROM VAT " & lString & " ORDER BY VAT_Name")
		'Display the list of Titles in the DataCombo
        DataList1.DataSource = gRS
		DataList1.listField = "VAT_Name"
