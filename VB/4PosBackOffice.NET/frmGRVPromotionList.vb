Option Strict Off
Option Explicit On
Friend Class frmGRVPromotionList
    ...
    Private Sub DataList1_DblClick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles DataList1.DoubleClick
        If DataList1.BoundText <> "" Then
            frmGRVPromotion.loadItem(CInt(DataList1.BoundText))
        End If
        doSearch()
    End Sub
    ...
    End Sub
	Private Sub frmGRVPromotionList_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
	...
	Private Sub frmGRVPromotionList_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		gRS.Close()
	End Sub
	...
	Private Sub doSearch()
		...
		End If
		gRS = getRS("SELECT DISTINCT PromotionID, Promotion_Name FROM GRVPromotion " & lString & " ORDER BY Promotion_Name")
