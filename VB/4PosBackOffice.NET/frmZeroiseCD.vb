...
Friend Class frmZeroiseCD
	...
	Private Sub loadLanguage()
		...
		rsLang.filter = "LanguageLayoutLnk_LanguageID=" & 2492 'Zeroise|Checked
		If rsLang.RecordCount Then frmZeroise.Text = rsLang.Fields("LanguageLayoutLnk_Description").Value : frmZeroise.RightToLeft = rsLang.Fields("LanguageLayoutLnk_RightTL").Value
		
		rsLang.filter = "LanguageLayoutLnk_LanguageID=" & 1004 'Exit|Checked
		If rsLang.RecordCount Then cmdExit.Text = rsLang.Fields("LanguageLayoutLnk_Description").Value : cmdExit.RightToLeft = rsLang.Fields("LanguageLayoutLnk_RightTL").Value
		
		rsLang.filter = "LanguageLayoutLnk_LanguageID=" & 2494 'Please Click start to zeroise all stock|Checked
	...
	Private Sub cmdExit_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdExit.Click
		Me.Close()
	End Sub
	Private Sub frmZeroiseCD_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		loadLanguage()
...
Extracter: 
	...
	Public Sub ExportToCSV(Optional ByVal PrintHeader As Boolean = True)
		...
		cmdExit.Enabled = False
		txtPassword.Enabled = False
		rsz = getRS("SELECT CustomerID FROM Customer")
		If rsz.RecordCount > 0 Then
			...
			MsgBox("Completed", MsgBoxStyle.OKOnly, "Customers")
		Else
			MsgBox("No Customers!", MsgBoxStyle.OKOnly, "Customers")
		End If
		...
		'closeConnection
	End Sub
	Private Sub frmZeroiseCD_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
	...
	Private Sub cmdProcess_Click(ByRef cID As Object)
