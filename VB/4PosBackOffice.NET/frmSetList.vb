...
Friend Class frmSetList
	...
	Private Sub loadLanguage()
		...
		'frmSetList = No Code   [Select a Stock Set]
		'NOTE: DB item 1096 contains 2x headings- the latter of which is
		'supposed to be this caption!!!
		...
		'UPGRADE_ISSUE: Form property frmSetList.ToolTip1 was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
	...
	Private Sub DataList1_DblClick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles DataList1.DoubleClick
		If cmdNew.Visible Then
			If DataList1.BoundText <> "" Then
				frmSet.loadItem(CInt(DataList1.BoundText))
			End If
			doSearch()
		Else
			If DataList1.BoundText = "" Then
	...
	End Sub
	Private Sub frmSetList_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
	...
	Private Sub frmSetList_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		doSearch()
		
		
	End Sub
	
	Private Sub frmSetList_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		gRS.Close()
	End Sub
	...
	Private Sub doSearch()
		...
		If lString = "" Then
		Else
			lString = "WHERE (Set_Name LIKE '%" & Replace(lString, " ", "%' AND Set_Name LIKE '%") & "%')"
		End If
		gRS = getRS("SELECT DISTINCT SetID, Set_Name FROM [Set] " & lString & " ORDER BY Set_Name")
		'Display the list of Titles in the DataCombo
		DataList1.DataSource = gRS
		DataList1.listField = "Set_Name"
