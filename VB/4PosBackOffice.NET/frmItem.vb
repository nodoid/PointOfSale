...
Friend Class frmItem
    ...
    Private Sub loadLanguage()
        ...
        rsLang.Filter = "LanguageLayoutLnk_LanguageID=" & 2390 'Compare Stock Item to Stock Item|
    ...
    Private Sub frmItem_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        cmdClear.AddRange(New Button() {_cmdClear_1, _cmdClear_2, _cmdClear_3, _cmdClear_4, _
                                        _cmdClear_5, _cmdClear_6, _cmdClear_7, _cmdClear_8, _
                                        _cmdClear_9, _cmdClear_10})
