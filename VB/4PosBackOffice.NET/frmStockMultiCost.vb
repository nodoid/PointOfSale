Option Strict Off
Option Explicit On
Friend Class frmStockMultiCost
	...
	Private Sub getNamespace()
		...
		End If
		adoPrimaryRS = getRS("SELECT StockItem_Name,StockItem_Quantity,StockItem_ListCost FROM StockItem " & gFilterSQL & " ORDER BY StockItem_Name")
		...
		frmStockMultiCost_Resize(Me, New System.EventArgs())
		mbDataChanged = False
	...
	Private Sub frmStockMultiCost_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		...
		loadLanguage()
	End Sub
	Private Sub frmStockMultiCost_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
	...
	Private Sub frmStockMultiCost_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
        ...
        grdDataGrid.Columns(0).Width = twipsToPixels(pixelToTwips(grdDataGrid.Width, True) - 1800 - 580, True)
		
	End Sub
	
	Private Sub frmStockMultiCost_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
