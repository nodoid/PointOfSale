...
Friend Class frmPricelistList
	...
	Private Sub loadLanguage()
		...
		rsLang.filter = "LanguageLayoutLnk_LanguageID=" & 1183 'Select a Price List Group|Checked
	...
	Private Sub DataList1_DblClick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles DataList1.DoubleClick
		...
		If cmdNew.Visible Then
			If DataList1.BoundText <> "" Then
				frmPriceList.loadItem(CInt(DataList1.BoundText))
			End If
			doSearch()
		Else
			If DataList1.BoundText = "" Then
	...
	End Sub
	Private Sub frmPricelistList_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
	...
	Private Sub frmPricelistList_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		gRS.Close()
	End Sub
	...
	Private Sub doSearch()
		...
		End If
		gRS = getRS("SELECT DISTINCT PricelistID, Pricelist_Name FROM Pricelist " & lString & " ORDER BY Pricelist_Name")
