...
Friend Class frmCustomerTransaction
    ...
    Private Sub cmdProcess_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles cmdProcess.Click
        ...
        Dim rs As ADODB.Recordset
        Dim id As String
        Dim days120, days60, current, days30, days90, days150 As Decimal
    ...
    Private Sub frmCustomerTransaction_Resize(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Resize
        Dim cmdLast As New System.Windows.Forms.Button
        Dim cmdNext As New System.Windows.Forms.Button
        Dim lblStatus As New System.Windows.Forms.Label
        On Error Resume Next
        lblStatus.Width = twipsToPixels(Me.Width, True) - 1500
        cmdNext.Left = lblStatus.Width + 700
        cmdLast.Left = cmdNext.Left + 340
    End Sub

    Private Sub frmCustomerTransaction_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmCustomerTransaction_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
...
UpdateErr:
    ...
    Private Sub txtFields_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs)
        ...
        t = GetIndexer(n, txtFields)
        MyGotFocus(txtFields(t))
    End Sub
    ...
    Private Sub txtFloat_Enter(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs)
        ...
        Dim n As New TextBox
        n = DirectCast(eventSender, TextBox)
        t = GetIndexer(n, txtFloat)
        MyGotFocusNumeric(txtFloat(t))
    End Sub
