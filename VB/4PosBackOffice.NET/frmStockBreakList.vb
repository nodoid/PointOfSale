Option Strict Off
Option Explicit On
Friend Class frmStockBreakList
	...
	Private Sub DataList1_DblClick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles DataList1.DoubleClick
		frmStockBreak.loadItem((DataList1.BoundText))
		doSearch()
	End Sub
	...
	End Sub
	Private Sub frmStockBreakList_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
	...
	Private Sub frmStockBreakList_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		gRS.Close()
	End Sub
	...
	Private Sub doSearch()
		...
		If lString = "" Then
		Else
			lString = "WHERE (StockItem.StockItem_Name LIKE '%" & Replace(lString, " ", "%' AND StockItem.StockItem_Name LIKE '%") & "%')"
		End If
		
		gRS = getRS("SELECT [StockBreak_ParentID] & '_' & [StockBreak_ChildID] AS [theKey], [StockItem]![StockItem_Name] & '->' & [StockItemChild]![StockItem_Name] AS name FROM (StockBreak INNER JOIN StockItem AS StockItemChild ON StockBreak.StockBreak_ChildID = StockItemChild.StockItemID) INNER JOIN StockItem ON StockBreak.StockBreak_ParentID = StockItem.StockItemID " & lString & " ORDER BY StockItem.StockItem_Name;")
