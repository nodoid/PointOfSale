...
Friend Class frmSupplierList
    ...
    Private Sub DataList1_DblClick(ByVal eventSender As System.Object, ByVal eventArgs As KeyEventArgs) Handles DataList1.DoubleClick
        If DataList1.BoundText <> "" Then
            Select Case gSection
                Case 0
                    frmSupplier.loadItem(CInt(DataList1.BoundText))
                Case 1
                    frmSupplierTransaction.loadItem(CInt(DataList1.BoundText), 0)
                Case 2
                    frmSupplierTransaction.loadItem(CInt(DataList1.BoundText), 1)
                Case 3
                    frmSupplierTransaction.loadItem(CInt(DataList1.BoundText), 2)
                Case 4
                    frmSupplierDeposits.loadItem(CInt(DataList1.BoundText))
            End Select
        End If
        doSearch()
    End Sub
	...
	Private Sub frmSupplierList_KeyDown(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
	...
	Private Sub frmSupplierList_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		gRS.Close()
	End Sub
	Private Sub frmSupplierList_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
