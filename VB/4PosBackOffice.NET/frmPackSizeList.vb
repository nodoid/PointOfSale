...
Friend Class frmPackSizeList
    ...
    Private Sub DataList1_DblClick(ByVal eventSender As System.Object, ByVal eventArgs As KeyEventArgs) Handles DataList1.DoubleClick
        ...
        If DataList1.BoundText <> "" Then
            frmPackSize.loadItem(CInt(DataList1.BoundText))
        End If
        doSearch()
    End Sub
	...
	Private Sub frmPackSizeList_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
	...
	Private Sub frmPackSizeList_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		gRS.Close()
	End Sub
	...
	Private Sub doSearch()
		...
		If lString = "" Then
		Else
			lString = "WHERE (PackSize_Name LIKE '%" & Replace(lString, " ", "%' AND PackSize_Name LIKE '%") & "%')"
		End If
		gRS = getRS("SELECT DISTINCT PackSizeID, PackSize_Name FROM PackSize " & lString & " ORDER BY PackSize_Name")
