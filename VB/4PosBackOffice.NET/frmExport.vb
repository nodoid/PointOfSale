...
Friend Class frmExport
	...
	Private Sub loadLanguage()
		...
		'UPGRADE_ISSUE: Form property frmExport.ToolTip1 was not upgraded. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="CC4C7EC0-C903-48FC-ACCC-81861D12DA4A"'
			...
			While Not oFile.AtEndOfLine
				...
				If strCSV <> vbNullString Then
					...
					If rs.RecordCount > 0 Then
						strIn = "UPDATE " & st_Name & " SET Quantity = " & rs.Fields("Quantity").Value + Val(strStr_2) & " WHERE Handheld_Barcode = '" & Trim(strStr_1) & "'"
					Else
						strIn = "INSERT INTO " & st_Name & " (Handheld_Barcode,Quantity) VALUES " & "('" & Trim(strStr_1) & "'," & Val(strStr_2) & ")"
					End If
