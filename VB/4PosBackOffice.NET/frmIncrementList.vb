...
Friend Class frmIncrementList
	...
	Private Sub loadLanguage()
		...
		rsLang.filter = "LanguageLayoutLnk_LanguageID=" & 1158 'Select Price Increment Group
    ...
    Private Sub DataList1_DblClick(ByVal eventSender As System.Object, ByVal eventArgs As KeyEventArgs) Handles DataList1.DoubleClick
        ...
        If cmdNew.Visible Then
            If DataList1.BoundText <> "" Then
                frmIncrement.loadItem(CInt(DataList1.BoundText))
            End If
            doSearch()
        Else
            If DataList1.BoundText = "" Then
    ...
    End Sub
	Private Sub frmIncrementList_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
	...
	Private Sub frmIncrementList_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		gRS.Close()
	End Sub
	...
	Private Sub doSearch()
		...
		If lString = "" Then
		Else
			lString = "WHERE (Increment_Name LIKE '%" & Replace(lString, " ", "%' AND Increment_Name LIKE '%") & "%')"
		End If
		gRS = getRS("SELECT DISTINCT IncrementID, Increment_Name FROM Increment " & lString & " ORDER BY Increment_Name")
