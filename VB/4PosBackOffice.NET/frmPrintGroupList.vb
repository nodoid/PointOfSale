Option Strict Off
Option Explicit On
Friend Class frmPrintGroupList
	...
	Private Sub DataList1_DblClick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles DataList1.DoubleClick
		If cmdNew.Visible Then
			If DataList1.BoundText <> "" Then
				frmPrintGroup.loadItem(CInt(DataList1.BoundText))
			End If
			doSearch()
		Else
			If DataList1.BoundText = "" Then
	...
	Private Sub frmPrintGroupList_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
		doSearch()
	End Sub
	
	Private Sub frmPrintGroupList_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		gRS.Close()
	End Sub
	...
	Private Sub doSearch()
		...
		If lString = "" Then
		Else
			lString = "WHERE (PrintGroup_Name LIKE '%" & Replace(lString, " ", "%' AND PrintGroup_Name LIKE '%") & "%')"
		End If
		gRS = getRS("SELECT DISTINCT * FROM PrintGroup " & lString & " ORDER BY PrintGroup_Name")
