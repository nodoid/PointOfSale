...
Friend Class frmGRVSummary
	...
	Private Sub setTotals()
		...
		Else
			lVat = IIf(IsDbNull(rs.Fields("vat").Value), 0, rs.Fields("vat").Value)
			lblLinesIn.Text = rs.Fields("itemCount").Value
			lExclusive = IIf(IsDbNull(rs.Fields("exclusive").Value), 0, rs.Fields("exclusive").Value)
			If lExclusive Then
	...
	Private Sub frmGRVSummary_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        saveDetails()
	End Sub
    ...
    Private Sub frmGRVSummary_Load(sender As Object, e As System.EventArgs) Handles Me.Load
