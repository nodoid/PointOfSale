...
Friend Class frmChannelList
	...
	Private Sub DataList1_DblClick(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles DataList1.DoubleClick
		If DataList1.BoundText <> "" Then
			frmChannel.loadItem(CInt(DataList1.BoundText))
		End If
		doSearch()
	End Sub
	...
	End Sub
	Private Sub frmChannelList_KeyPress(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.KeyPressEventArgs) Handles MyBase.KeyPress
	...
	Private Sub frmChannelList_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
	...
	Private Sub frmChannelList_FormClosed(ByVal eventSender As System.Object, ByVal eventArgs As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
		gRS.Close()
	End Sub
	...
	Private Sub doSearch()
		...
		If lString = "" Then
		Else
			lString = "WHERE (Channel_Name LIKE '%" & Replace(lString, " ", "%' AND Channel_Name LIKE '%") & "%')"
		End If
		gRS = getRS("SELECT DISTINCT ChannelID, Channel_Name FROM Channel " & lString & " ORDER BY ChannelID")
