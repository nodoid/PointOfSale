...
{
	internal partial class frmFilterList : System.Windows.Forms.Form
	{
		string gField;
		string[,] gArray;
		bool loading;
		...
		private void frmFilterList_FormClosed(System.Object eventSender, System.Windows.Forms.FormClosedEventArgs eventArgs)
		{
			save();
		}
		...
		private void frmFilterList_Load(object sender, System.EventArgs e)
		{
