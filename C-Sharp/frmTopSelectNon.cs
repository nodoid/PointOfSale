...
{
	internal partial class frmTopSelectNon : System.Windows.Forms.Form
	{
		...
		private void cmdLoad_Click(System.Object eventSender, System.EventArgs eventArgs)
		{
			...
			if (this._optType_0.Checked) {
				Report.Load("cryStockitemTop1Non.rpt");
			} else if (this._optType_1.Checked) {
		...
		private void frmTopSelectNon_KeyPress(System.Object eventSender, KeyPressEventArgs eventArgs)
		{
		...
		private void frmTopSelectNon_Leave(object sender, System.EventArgs e)
		{
		}
		private void frmTopSelectNon_Load(System.Object eventSender, System.EventArgs eventArgs)
		{
		...
		private void optType_CheckedChanged(System.Object eventSender, System.EventArgs eventArgs)
		{
			if (eventSender.Checked) {
				...
				n = (RadioButton)eventSender;
				Index = GetIndex.GetIndexer(ref n, ref optType);
				foreach (RadioButton m_loopVariable in optType) {
					m = m_loopVariable;
					if (Index) {
