...
namespace _4PosBackOffice.NET
{
	...
	partial class frmStockMultiPrice
	{
		#region "Windows Form Designer generated code "
		[System.Diagnostics.DebuggerNonUserCode()]
		public frmStockMultiPrice() : base()
		{
			FormClosed += frmStockMultiPrice_FormClosed;
			Resize += frmStockMultiPrice_Resize;
			KeyPress += frmStockMultiPrice_KeyPress;
			Load += frmStockMultiPrice_Load;
