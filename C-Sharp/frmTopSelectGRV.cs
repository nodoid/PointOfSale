...
{
	internal partial class frmTopSelectGRV : System.Windows.Forms.Form
	{
		...
		private void cmdLoad_Click(System.Object eventSender, System.EventArgs eventArgs)
		{
			...
			if (this.optType[0].Checked) {
				Report.Load("cryStockitemTop1GRV.rpt");
			} else if (this.optType[1].Checked) {
		...
		private void frmTopSelectGRV_KeyPress(System.Object eventSender, System.Windows.Forms.KeyPressEventArgs eventArgs)
		{
		...
		private void frmTopSelectGRV_Load(System.Object eventSender, System.EventArgs eventArgs)
		{
