...
{
	internal partial class frmPricelistFilterList : System.Windows.Forms.Form
	{
		string gFilter;
		ADODB.Recordset gRS;
		string gFilterSQL;
		...
		{
			My.MyProject.Forms.frmPricelistFilter.loadItem(ref 0);
			doSearch();
		}
		...
		private void DataList1_DblClick(System.Object eventSender, System.EventArgs eventArgs)
		{
			...
			if (cmdNew.Visible) {
				if (!string.IsNullOrEmpty(DataList1.BoundText)) {
					My.MyProject.Forms.frmPricelistFilter.loadItem(ref Convert.ToInt32(DataList1.BoundText));
				}
				doSearch();
			} else {
				if (string.IsNullOrEmpty(DataList1.BoundText)) {
		...
		private void frmPricelistFilterList_KeyPress(System.Object eventSender, System.Windows.Forms.KeyPressEventArgs eventArgs)
		{
		...
		private void frmPricelistFilterList_FormClosed(System.Object eventSender, System.Windows.Forms.FormClosedEventArgs eventArgs)
		{
			gRS.Close();
		}
		...
		private void doSearch()
		{
			...
			gRS = modRecordSet.getRS(ref "SELECT DISTINCT PricelistID, Pricelist_Name FROM PricelistFilter " + lString + " ORDER BY Pricelist_Name");
