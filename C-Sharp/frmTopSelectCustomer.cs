...
{
	internal partial class frmTopSelectCustomer : System.Windows.Forms.Form
	{
		int lEmpID;
		...
		private void loadLanguage()
		{
			...
			if (modRecordSet.rsLang.RecordCount){My.MyProject.Forms.frmTopSelect.Text = modRecordSet.rsLang.Fields("LanguageLayoutLnk_Description").Value;My.MyProject.Forms.frmTopSelect.RightToLeft = modRecordSet.rsLang.Fields("LanguageLayoutLnk_RightTL").Value;}
		...
		private void frmTopSelectCustomer_KeyPress(System.Object eventSender, System.Windows.Forms.KeyPressEventArgs eventArgs)
		{
		...
		private void frmTopSelectCustomer_Load(System.Object eventSender, System.EventArgs eventArgs)
		{
...
//UPGRADE_WARNING: Event optType.CheckedChanged may fire when form is initialized. Click for more: 'ms-help://MS.VSCC.v90/dv_commoner/local/redirect.htm?keyword="88B12AE1-6DE0-48A0-86F1-60C0686C026A"'
		...
		private void optType_CheckedChanged(System.Object eventSender, System.EventArgs eventArgs)
		{
			if (eventSender.Checked) {
				...
				int Index = GetIndex.GetIndexer(ref rb, ref optType);
				if (Index) {
