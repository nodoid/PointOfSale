...
namespace _4PosBackOffice.NET
{
	...
	partial class frmBlockTest
	{
		#region "Windows Form Designer generated code "
		[System.Diagnostics.DebuggerNonUserCode()]
		public frmBlockTest() : base()
		{
			Resize += frmBlockTest_Resize;
			Load += frmBlockTest_Load;
			KeyPress += frmBlockTest_KeyPress;
...
//Required by the Windows Form Designer
		...
		private System.Windows.Forms.Button withEventsField_cmdLoadNext;
		public System.Windows.Forms.Button cmdLoadNext {
			get { return withEventsField_cmdLoadNext; }
			set {
				if (withEventsField_cmdLoadNext != null) {
					withEventsField_cmdLoadNext.Click -= cmdLoadNext_Click;
				}
				withEventsField_cmdLoadNext = value;
				if (withEventsField_cmdLoadNext != null) {
					withEventsField_cmdLoadNext.Click += cmdLoadNext_Click;
				}
			}
