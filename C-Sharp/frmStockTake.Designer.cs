...
namespace _4PosBackOffice.NET
{
	...
	partial class frmStockTake
	{
		...
		{
			FormClosed += frmStockTake_FormClosed;
			KeyPress += frmStockTake_KeyPress;
			Resize += frmStockTake_Resize;
...
//Required by the Windows Form Designer
		...
		private System.Windows.Forms.Button withEventsField_cmdPrintDiff;
		public System.Windows.Forms.Button cmdPrintDiff {
			get { return withEventsField_cmdPrintDiff; }
			set {
				if (withEventsField_cmdPrintDiff != null) {
					withEventsField_cmdPrintDiff.Click -= cmdPrintDiff_Click;
				}
				withEventsField_cmdPrintDiff = value;
				if (withEventsField_cmdPrintDiff != null) {
					withEventsField_cmdPrintDiff.Click += cmdPrintDiff_Click;
				}
			}
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmStockTake));
			this.components = new System.ComponentModel.Container();
			this.ToolTip1 = new System.Windows.Forms.ToolTip(components);
			this.picButtons = new System.Windows.Forms.Panel();
			this.cmdPrintDiff = new System.Windows.Forms.Button();
			...
			this.Text = "Stock Take Adjustments";
			...
			this.cmdPrintDiff.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			this.cmdPrintDiff.Text = "Print &Difference";
			this.cmdPrintDiff.Size = new System.Drawing.Size(89, 29);
			this.cmdPrintDiff.Location = new System.Drawing.Point(332, 3);
			this.cmdPrintDiff.TabIndex = 5;
			this.cmdPrintDiff.TabStop = false;
			this.cmdPrintDiff.BackColor = System.Drawing.SystemColors.Control;
			this.cmdPrintDiff.CausesValidation = true;
			this.cmdPrintDiff.Enabled = true;
			this.cmdPrintDiff.ForeColor = System.Drawing.SystemColors.ControlText;
			this.cmdPrintDiff.Cursor = System.Windows.Forms.Cursors.Default;
			this.cmdPrintDiff.RightToLeft = System.Windows.Forms.RightToLeft.No;
			this.cmdPrintDiff.Name = "cmdPrintDiff";
			this.cmdClose.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			this.cmdClose.Text = "E&xit";
			this.cmdClose.Size = new System.Drawing.Size(65, 29);
			this.cmdClose.Location = new System.Drawing.Point(497, 3);
			...
			this.cmdPrint.Size = new System.Drawing.Size(65, 29);
			this.cmdPrint.Location = new System.Drawing.Point(426, 3);
			...
			this.lblHeading.Size = new System.Drawing.Size(323, 22);
			...
			this.picButtons.Controls.Add(cmdPrintDiff);
