...
{
	internal partial class frmPromotionList : System.Windows.Forms.Form
	{
		string gFilter;
		ADODB.Recordset gRS;
		string gFilterSQL;
		...
		{
			My.MyProject.Forms.frmPromotion.loadItem(ref 0);
			doSearch();
		}
		...
		private void DataList1_DblClick(System.Object eventSender, KeyPressEventArgs eventArgs)
		{
			if (!string.IsNullOrEmpty(DataList1.BoundText)) {
				My.MyProject.Forms.frmPromotion.loadItem(ref Convert.ToInt32(DataList1.BoundText));
			}
			doSearch();
		}
		...
		private void frmPromotionList_KeyPress(System.Object eventSender, System.Windows.Forms.KeyPressEventArgs eventArgs)
		{
		...
		private void frmPromotionList_FormClosed(System.Object eventSender, System.Windows.Forms.FormClosedEventArgs eventArgs)
		{
			gRS.Close();
		}
		...
		private void doSearch()
		{
			...
			gRS = modRecordSet.getRS(ref "SELECT DISTINCT PromotionID, Promotion_Name FROM Promotion " + lString + " ORDER BY Promotion_Name");
