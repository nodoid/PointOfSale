...
namespace _4PosBackOffice.NET
{
	...
	partial class frmStockTakeLIQ
	{
		#region "Windows Form Designer generated code "
		[System.Diagnostics.DebuggerNonUserCode()]
		public frmStockTakeLIQ() : base()
		{
			FormClosed += frmStockTakeLIQ_FormClosed;
			Load += frmStockTakeLIQ_Load;
			KeyPress += frmStockTakeLIQ_KeyPress;
...
//Required by the Windows Form Designer
		...
		private System.Windows.Forms.Timer withEventsField_tmrGetWei;
		public System.Windows.Forms.Timer tmrGetWei {
			get { return withEventsField_tmrGetWei; }
			set {
				if (withEventsField_tmrGetWei != null) {
					withEventsField_tmrGetWei.Tick -= tmrGetWei_Tick;
				}
				withEventsField_tmrGetWei = value;
				if (withEventsField_tmrGetWei != null) {
					withEventsField_tmrGetWei.Tick += tmrGetWei_Tick;
				}
			}
		...
		public myDataGridView DataGrid1;
