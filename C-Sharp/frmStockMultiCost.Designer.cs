...
namespace _4PosBackOffice.NET
{
	...
	partial class frmStockMultiCost
	{
		#region "Windows Form Designer generated code "
		[System.Diagnostics.DebuggerNonUserCode()]
		public frmStockMultiCost() : base()
		{
			FormClosed += frmStockMultiCost_FormClosed;
			Resize += frmStockMultiCost_Resize;
			KeyPress += frmStockMultiCost_KeyPress;
			Load += frmStockMultiCost_Load;
...
//Required by the Windows Form Designer
		...
		private myDataGridView withEventsField_grdDataGrid;
		public myDataGridView grdDataGrid {
			get { return withEventsField_grdDataGrid; }
			set {
				if (withEventsField_grdDataGrid != null) {
					withEventsField_grdDataGrid.CellValueChanged -= grdDataGrid_CellValueChanged;
				}
...
//Do not modify it using the code editor.
		...
		{
			System.Resources.ResourceManager resources = new System.Resources.ResourceManager(typeof(frmStockMultiCost));
			...
			this.Text = "Edit Stock Item Costs";
